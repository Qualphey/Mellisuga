...
var Editor = /** @class */ (function () {
    function Editor(context) {
         ...
         */
        this.fontName = this.wrapCommand(function (fontName) {
            // [workaround]
        ...
        this.removeMedia = this.wrapCommand(function () {
            var $target = $$1(_this.restoreTarget()).detach();
     ...
     */
    Editor.prototype.fontSize = function (value) {
        var rng = this.createRange();
        if (rng && rng.isCollapsed()) {
            ...
            this.beforeCommand();
            $$1(this.style.styleNodes(rng)).css({
                'font-size': value + 'px'
            });
            this.afterCommand();
        }
